          ...
          <div className="w-full h-full flex items-center absolute top-0 left-0 md:pt-12 sm:pt-52 pt-56">
            <div className="container grid md:grid-cols-2 items-center">
              <div className="space-y-6">
                ...
                <p>
                  NESA stands as the pinnacle award of the decade, a fervent celebration of excellence within the
                  Nigerian education system. We uplift contributors, ignite innovation, and envision an ecosystem where
