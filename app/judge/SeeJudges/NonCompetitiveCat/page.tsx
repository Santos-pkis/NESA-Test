...
const judges = [
  {
    id: 1,
    name: 'Best Educational-Friendly State (Nigeria by Zone)',
    url: ''
  },
  {
    id: 1,
  ...
  {
    id: 1,
    name: 'Best Research Institutions in Nigeria',
    url: ''
  },
  {
    id: 1,
    name: 'Africa Lifetime Education Icon Recognition',
    url: ''
  },
  {
    id: 1,
    name: 'Best Faith-Based Organization in Education404',
    url: ''
  },
  {
    id: 1,
    name: 'Best Political Leaders\' Educational Support Services',
    url: ''
  },
  {
    id: 1,
    name: 'Best STEM Education Champion404',
    url: ''
  },
  {
    id: 1,
    name: 'Diaspora Education Impact Awards404',
    url: ''
  },
  {
    id: 1,
    name: 'Best International & Bilateral Contributors to Education404',
    url: ''
  },
  {
    id: 1,
    name: 'Diaspora Contributions to Education in Africa404',
    url: ''
  },
  {
    id: 1,
    name: 'Best Corporate Social Responsibility (CSR) in Education (Nigeria)',
    url: ''
  },
  {
    id: 1,
    name: 'Best CSR in Education (Africa)',
    url: ''
  },
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12 px-10 md:mt-20 ">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold mb-2">See Judges in Categories of the Non-Competitive Categories</h1>
