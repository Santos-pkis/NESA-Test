        ...
        <div className={styles.insidecont}>
          ...
          <div className={styles.grid}>
             ...
             <div className="flex flex-wrap gap-4">
                <a href="#" className="bg-gradient-to-r from-[#FFC247] to-[#E48900] hover:bg-amber-500 text-black font-medium py-3 px-8 rounded-md transition-colors">
                  Apply To Judge
                </a>
                <a href="#" className="bg-gradient-to-r from-[#E1E1E1] to-[#BDBDBD] hover:bg-gray-300 text-black font-medium py-3 px-8 rounded-md transition-colors">
                  Nominate A Judge
                </a>
             </div>
             </div>
